<template>
    <div class="bg-[#cddbe5] flex flex-col items-start justify-start min-h-screen py-20 px-16">
        ...
        <a href="#" class="flex items-center">
            <!-- Button -->
            <button class="w-[56px] h-[56px] bg-[#FAC950] text-black rounded-full flex items-center justify-center">
                <img src="../assets/icon/back.svg" class="w-[28px] h-[22px]" />
            </button>
            <!-- Title -->
            <h1 class="text-[#267DC2] text-left font-poppins text-5xl font-semibold p-5 text-[30px]">
