<template>
  <div class="relative" @mouseover="showDropdown" @mouseleave="scheduleHideDropdown">
    <div class="flex items-center gap-2 p-2" aria-haspopup="true" :aria-expanded="isDropdownVisible.toString()" role="button">
      <img src="@/assets/icon/account.svg" alt="User Photo" class="w-[3.75rem] h-[3.75rem] shrink-0">
    ...
    <div v-if="isDropdownVisible" class="absolute right-0 mt-3 w-[15.25rem] bg-[#1A5796] shadow-md rounded-md p-4 flex flex-col gap-2" @mouseenter="cancelHideDropdown" @mouseleave="scheduleHideDropdown">
