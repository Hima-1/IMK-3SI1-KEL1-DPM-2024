<template>
  <div class="bg-[#EBF3F5] min-h-screen flex items-center justify-center">
    <div class="wrapper flex flex-col items-center justify-center pt-10 pb-20 px-10">
      ...
      <p class="text-[#1A5796] text-[20px] lg:text-[18px] text-center font-poppins font-normal mt-4 lg:mt-8 lg:px-40">
      ...
      <div class="text-[#1A5796] text-[20px] lg:text-[18px] font-normal mt-4 lg:mt-8 lg:px-10">
        <div class="flex items-start">
          <div
            class="circle-number bg-no-repeat bg-contain h-[27.3px] w-[48px] lg:h-[40px] lg:w-[40px] flex-shrink-0 text-center">
            1</div>
          <p class="text-[#1A5796] text-[20px] lg:text-[18px] text-left font-poppins font-normal ml-4">
