            ...
            <div class="bg-[#EBF3F5] rounded-[12px] flex-shrink-0 w-full h-full">
                ...
                <div class="p-4">
                    <div class="flex items-center justify-between mb-4">
                        <div class="flex items-center">
                            ...
                            <!-- Tanggal -->
                            <p class="text-[#15649D] font-poppins text-[18px] font-medium ml-2">KAMIS, 12 Juni 2023
                                08:48 WIB</p>
                        </div>
                    </div>
                    <!-- Isi Berita -->
                    <p class="text-[#000] font-poppins text-[16px] mb-4">
                    ...
                    <router-link to="/berita/selengkapnya">
                        <button
                            class="bg-[#1A5796] text-white font-poppins text-[15px] font-medium rounded-[6px] w-[170px] h-[37px] flex items-center justify-center mt-5">
                            Selengkapnya
                ...
                <div class="p-4">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            <!-- Ikon Penulis -->
                            <img src="@/assets/icon/person.svg" class="w-auto h-[19px] flex-shrink-0 text-[#15649D]" />
                            <!-- Nama Penulis -->
                            <p class="text-[#15649D] font-poppins text-[15px] font-medium ml-2">Pororo ajaaah</p>
                        </div>
                        <div class="flex items-center">
                            <!-- Ikon Tanggal -->
                            <img src="@/assets/icon/blueeye.svg" class="w-auto h-[15px] flex-shrink-0 text-[#15649D]" />
                            <!-- Tanggal Berita -->
                            <p class="text-[#15649D] font-poppins text-[15px] font-medium ml-2">692</p>
                        </div>
                    </div>
                </div>
            </div>
